...
!$acc parallel
    ...
    !*****************************************************************
    ! For gfortran to see a module array in a subroutine running
    ...
    ! as a parameter.  Subsequent subroutines that run within an OpenACC
    ...
    !
    ! nvfortran is able to execute all the subroutines in the OpenACC parallel
